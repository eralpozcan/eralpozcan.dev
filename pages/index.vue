<template>
  <div class="hero min-h-screen bg-base-200">
    <div class="hero-content flex-col lg:flex-row-reverse">
      <img src="/assets/images/profile_pic.webp" width="612" height="612" loading="lazy" class="sm:max-w-sm md:max-w-md lg:max-w-md rounded-lg" alt="Eralp Özcan Profile Picture" />
      <div>
